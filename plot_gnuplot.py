...
DEFAULT_SETTINGS = LIB_DIR / "plot-settings.ini"
...
def build_gnuplot_script(
    ...
    format_note = (
        ...
        "# Prefer editing Lib/plot-settings.ini [output] format, then re-run this script.\n"
    )

    script = f"""# Auto-generated by Lib/plot_gnuplot.py (Version {VERSION})
{format_note}reset
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=f"Path to plot-settings.ini (default: {DEFAULT_SETTINGS}).",
    )
    parser.add_argument(
        "--format",
